...
| 0006 | [Retained-Mode UI on the Scatter/SoT Paradigm](ADR-0006-retained-mode-ui.md) | Phases 1–2 landed | `crates/engine-render/src/ui/` (`UiCore` + `UiGpu`), `shaders/{ui.vert,ui.frag,ui_scatter.comp,ui_build_args.comp}` |
