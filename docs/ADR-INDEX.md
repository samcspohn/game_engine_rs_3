...
| 0011 | [Worlds: a Hierarchy and a Registry per Scene](ADR-0011-worlds.md) | Accepted (steps 1–2 built; §3 revised — worlds are engine-owned and refcounted) | `crates/engine-core/src/{component/{mod,world},worlds,scene_asset,transform/mod}.rs`, `crates/engine-editor-api/src/lib.rs`, `crates/engine-render/src/{lib,components,scene}.rs`, `crates/editor/` |
