...
| 0003 | [Shared Staging Buffers with Compute-Stage Timeline Sync](ADR-0003-shared-staging-with-compute-sync.md) | Partially landed | `crates/engine-render/{transform_gpu,swapchain,lib}.rs` |
